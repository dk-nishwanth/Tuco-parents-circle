      ...
      <header className="bg-white border-b border-neutral-100 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-2 flex items-center justify-between gap-4">
          ...
          <div className="flex-1 max-w-[440px]">
            <div className="bg-[#F3F4F6] border border-neutral-200 rounded-lg h-9 w-full flex items-center px-4 gap-3">
              <Search className="w-4 h-4 text-neutral-400" strokeWidth={2} />
              <input 
                type="text"
                placeholder="Search Parents Circle..."
                className="w-full bg-transparent text-[14px] text-[#4D4747] placeholder-neutral-400 outline-none"
                readOnly
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button className="p-1.5 hover:bg-neutral-50 rounded-full transition-colors">
              <Bell className="w-6 h-6 text-[#4D4747]" strokeWidth={1.5} />
            </button>
