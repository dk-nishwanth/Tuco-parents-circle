...
export function ReportModal({ isOpen, onClose, onSubmit, type }: ReportModalProps) {
  ...
  return (
    ...
    >
      <div role="dialog" aria-modal="true" aria-label={`Report ${type}`} className="bg-white border border-neutral-200 rounded-3xl w-full max-w-md overflow-hidden shadow-xl animate-in fade-in-50 zoom-in-95 duration-200 relative my-auto">
