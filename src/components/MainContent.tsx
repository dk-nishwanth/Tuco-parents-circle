  ...
  return (
    <main className="main min-w-0 flex flex-col gap-4 md:gap-6">
      ...
      {showHighlight && threadOfWeek && currentPage === 1 && (
        ...
        <div className="-mx-3 sm:-mx-4 md:mx-0 rounded-none sm:rounded-[2rem] md:rounded-[2.25rem] bg-[#FFE259] px-4 md:px-6 pt-2 md:pt-3 pb-5 md:pb-7 shadow-sm md:border md:border-[#7EC7E8]">
